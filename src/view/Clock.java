...
public class Clock extends JPanel implements ActionListener {
    ...
    public Clock(int iHoraLocal,int iMinutoLocal,int iSegundoLocal,boolean booUTC) {
    ...
    private void CrearMenuPopup(){
        ...
        rbLocal.addItemListener(new ItemListener(){
            public void itemStateChanged(ItemEvent e){
                cal=Calendar.getInstance();
                iHoraLocal=cal.get(Calendar.getInstance().HOUR_OF_DAY);
                iDia=cal.get(Calendar.DAY_OF_MONTH);
                lblLogoHora.setIcon(imgLogo_HoraLocal);
                setHora(iHoraLocal);
