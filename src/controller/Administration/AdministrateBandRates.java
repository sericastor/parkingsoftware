...
public class AdministrateBandRates {
    ...
    public static void updateRow(int row, String from, String to, String fraction, String value,VehicleType vehicletype) {
        ...
        aux.setId(AllBandsRate.get(row).getId());
        try {
    ...
    public static void rowIsEdited(int row, String from, String to, String fraction, String value,VehicleType vehicletype) {
        ...
        if (!String.valueOf(AllBandsRate.get(row).getFromm()).equals(from)) {
            updateRow(row, from, to, fraction, value, vehicletype);
            return;
